...
//ZzaU::Don't decrease smaller than 205KB for android!! Caution!! => Sync with tcc_cdk_wrapper.h!!
#define DEFAULT_IN_BUFFER_SIZE  		202 * 1024 
//ZzaU::Partial-frame and incomplete-frame is regarding because this buffer size is too big to use.
#define DEFAULT_OUT_BUFFER_SIZE 		(3200 * 1024)
//#define DEFAULT_IN_BUFFER_SIZE  32 * 1024
//#define DEFAULT_OUT_BUFFER_SIZE (2 * 1024 * 1024)

#define	VIDEO_DEC_OUT_BUFFER_SIZE		1024*1024
//Caution!! => Sync with tcc_cdk_wrapper.h!!
#define VIDEO_DEC_IN_BUFFER_SIZE 		(4 * 1024 * 1024)
#else
#define DEFAULT_IN_BUFFER_SIZE  32 * 1024 //16384
#define DEFAULT_OUT_BUFFER_SIZE (4 * 1024 * 1024) // 1024 * 1024 // 65536
...
*/
#define	AUDIO_DXB_OUT_BUFFER_SIZE		1024*1024
